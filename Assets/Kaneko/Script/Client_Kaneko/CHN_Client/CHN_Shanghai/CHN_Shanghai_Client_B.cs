...
public class CHN_Shanghai_Client_B : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject CHN_Shanghai_ClientB_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        CHN_Shanghai_ClientB_Panel.SetActive(true);
    }
}
