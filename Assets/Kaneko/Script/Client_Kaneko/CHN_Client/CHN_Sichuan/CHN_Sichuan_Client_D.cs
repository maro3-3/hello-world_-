...
public class CHN_Sichuan_Client_D : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject CHN_Sichuan_ClientD_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        CHN_Sichuan_ClientD_Panel.SetActive(true);
    }
}
