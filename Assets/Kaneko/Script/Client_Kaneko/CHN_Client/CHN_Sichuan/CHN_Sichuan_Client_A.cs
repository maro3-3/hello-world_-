...
public class CHN_Sichuan_Client_A : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject CHN_Sichuan_ClientA_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        CHN_Sichuan_ClientA_Panel.SetActive(true);
    }
}
