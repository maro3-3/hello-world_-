...
public class CHN_Beijing_Client_B : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject CHN_Beijing_ClientB_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        CHN_Beijing_ClientB_Panel.SetActive(true);
    }
}
