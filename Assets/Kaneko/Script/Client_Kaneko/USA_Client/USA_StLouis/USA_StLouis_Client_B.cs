...
public class USA_StLouis_Client_B : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject USA_StLouis_Client_B_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        USA_StLouis_Client_B_Panel.SetActive(true);
    }
}
