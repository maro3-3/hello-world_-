...
public class USA_StLouis_Client_C : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject USA_StLouis_Client_C_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        USA_StLouis_Client_C_Panel.SetActive(true);
    }
}
