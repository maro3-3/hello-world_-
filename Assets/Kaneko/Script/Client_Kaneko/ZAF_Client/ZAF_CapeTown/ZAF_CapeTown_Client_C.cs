...
public class ZAF_CapeTown_Client_C : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject ZAF_CapeTown_Client_C_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        ZAF_CapeTown_Client_C_Panel.SetActive(true);
    }
}
