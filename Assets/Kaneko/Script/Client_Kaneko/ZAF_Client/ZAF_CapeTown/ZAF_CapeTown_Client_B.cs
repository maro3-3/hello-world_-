...
public class ZAF_CapeTown_Client_B : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject ZAF_CapeTown_Client_B_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        ZAF_CapeTown_Client_B_Panel.SetActive(true);
    }
}
