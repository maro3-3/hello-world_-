...
public class RUS_Moscow_Client_C : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject RUS_Moscow_Client_C_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        RUS_Moscow_Client_C_Panel.SetActive(true);
    }
}
