...
public class RUS_Moscow_Client_A : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject RUS_Moscow_Client_A_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        RUS_Moscow_Client_A_Panel.SetActive(true);
    }
}
