...
public class RUS_Moscow_Client_B : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject RUS_Moscow_Client_B_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        RUS_Moscow_Client_B_Panel.SetActive(true);
    }
}
