...
public class RUS_Ufa_Client_A : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject RUS_Ufa_Client_A_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        RUS_Ufa_Client_A_Panel.SetActive(true);
    }
}
