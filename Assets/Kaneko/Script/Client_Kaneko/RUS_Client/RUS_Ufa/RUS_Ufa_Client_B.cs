...
public class RUS_Ufa_Client_B : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject RUS_Ufa_Client_B_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        RUS_Ufa_Client_B_Panel.SetActive(true);
    }
}
