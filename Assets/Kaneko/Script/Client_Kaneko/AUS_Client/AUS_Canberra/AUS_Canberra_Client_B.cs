...
public class AUS_Canberra_Client_B : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject AUS_Canberra_Client_B_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        AUS_Canberra_Client_B_Panel.SetActive(true);
    }
}
