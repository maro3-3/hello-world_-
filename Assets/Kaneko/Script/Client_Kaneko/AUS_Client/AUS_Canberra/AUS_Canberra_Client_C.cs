...
public class AUS_Canberra_Client_C : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject AUS_Canberra_Client_C_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        AUS_Canberra_Client_C_Panel.SetActive(true);
    }
}
