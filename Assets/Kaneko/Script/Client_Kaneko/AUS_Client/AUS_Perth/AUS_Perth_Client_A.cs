...
public class AUS_Perth_Client_A : MonoBehaviour, IPointerClickHandler
{
    ...
    [SerializeField] private GameObject AUS_Perth_Client_A_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        AUS_Perth_Client_A_Panel.SetActive(true);
    }
}
