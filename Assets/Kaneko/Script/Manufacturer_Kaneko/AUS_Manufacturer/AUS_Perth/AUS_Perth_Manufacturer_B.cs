...
public class AUS_Perth_Manufacturer_B : MonoBehaviour, IPointerClickHandler
{
    [SerializeField] private GameObject BG_Panel;
    [SerializeField] private GameObject ManufacturerPanel;
    [SerializeField] private GameObject AUS_Perth_ManuList_Panel;
    [SerializeField] private GameObject AUS_Perth_Manufacturer_B_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        AUS_Perth_Manufacturer_B_Panel.SetActive(true);
    }
}
