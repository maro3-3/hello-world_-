...
public class RUS_Ufa_Manufacturer_B : MonoBehaviour, IPointerClickHandler
{
    [SerializeField] private GameObject BG_Panel;
    [SerializeField] private GameObject ManufacturerPanel;
    [SerializeField] private GameObject RUS_Ufa_ManuList_Panel;
    [SerializeField] private GameObject RUS_Ufa_Manufacturer_B_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        RUS_Ufa_Manufacturer_B_Panel.SetActive(true);
    }
}
