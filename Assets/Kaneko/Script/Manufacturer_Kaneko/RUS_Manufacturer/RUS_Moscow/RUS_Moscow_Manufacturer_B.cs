...
public class RUS_Moscow_Manufacturer_B : MonoBehaviour, IPointerClickHandler
{
    [SerializeField] private GameObject BG_Panel;
    [SerializeField] private GameObject ManufacturerPanel;
    [SerializeField] private GameObject RUS_Moscow_ManuList_Panel;
    [SerializeField] private GameObject RUS_Moscow_Manufacturer_B_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        RUS_Moscow_Manufacturer_B_Panel.SetActive(true);
    }
}
