...
public class USA_Area_Manufacturer : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        RUS_Area_ManufacturerPanel.SetActive(false);
        ...
        USA_Area_ManufacturerPanel.SetActive(true);
    }
}
