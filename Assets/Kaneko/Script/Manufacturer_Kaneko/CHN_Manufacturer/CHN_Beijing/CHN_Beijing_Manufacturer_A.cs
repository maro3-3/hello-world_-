...
public class CHN_Beijing_Manufacturer_A : MonoBehaviour, IPointerClickHandler
{
    [SerializeField] private GameObject BG_Panel;
    [SerializeField] private GameObject ManufacturerPanel;
    [SerializeField] private GameObject CHN_Beijing_ManuList_Panel;
    [SerializeField] private GameObject CHN_Beijing_ManufacturerA_Panel;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        CHN_Beijing_ManufacturerA_Panel.SetActive(true);
    }
}
